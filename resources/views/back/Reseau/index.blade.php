...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            @include('back.Reseau.delete_modal')
            @include('back.Reseau.deleteAll_modal')
            <div class="form-group text-ridght">
                ...
                <a href="{{ route('back.reseau.index') }}" class="btn bg-warning-light" data-toggle="tooltip"
                ...
                <a href="{{ route('back.reseau.create') }}" class="btn btn-primary pull-right"><i
            ...
            <div class="card card-table">
                <div class="card-header">
                    <h4 class="card-title"> Liste des Reseaux </h4>
                </div>
                <div class="card-body">
                    <div class="">
                            ...
                            <tbody>
                                @foreach ($reseaus as $reseau)
                                    <tr>
                                        ...
                                        <td data-id="{{ $reseau->id }}">#{{ $loop->index + 1 }}</td>
                                        {{-- <td>{{ $car->nom }}</td> --}}
                                        							<td>{{ $reseau->nom }}</td>

                                        <td>
                                            <a href="{{ route('back.reseau.show', $reseau->id) }}"
                                                class="btn bg-success-light btn-sm mr-1" title="Voir">
                                                <span class="text-success"><i class="fa fa-eye"></i> Voir</span>
                                            </a>
                                            <a href="{{ route('back.reseau.edit', $reseau->id) }}"
                                            ...
                                            <a href="#" class="btn bg-danger-light btn-sm btn-delete"
                                                data-nom="{{ $reseau->nom }}" data-id="{{ $reseau->id }}"
...
@section('script')
    ...
    <script>
        window.history.pushState('data', 'index', '{{ route('back.reseau.index') }}')
